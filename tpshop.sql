...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 16, 2023 lúc 09:00 AM
...
INSERT INTO `tbl_customer` (`id`, `fullName`, `phoneNumber`, `username`, `password`, `email`, `userImage`) VALUES
(10, 'Nguyen Thi Linh Phuong', '12345678901', 'linhphuong', 'c4ca4238a0b923820dcc509a6f75849b', 'linhphuong@gmail.com', ''),
(12, 'User', 'none', 'username12', 'e199aa8351d99658dd861e561d87dba9', 'none@gmail.com', 'faceIcon.jpg'),
(13, 'Đại Gia Tiền Lẻ', '1234568909', 'ethan', 'c4ca4238a0b923820dcc509a6f75849b', 'admin@gmail.com', 'edf5967b33.jpg');
...
(121741, 36, 'Samsung Galaxy S22 Ultra 5G (12GB | 256GB)', 10, 1, '16489000', 'trang_4k05-pq.jpg', 2, '2023-06-15 12:59:10'),
(121742, 25, 'iPad Pro M2 11-inch (2022) | 128GB Wifi', 10, 1, '21989000', 'iPad-New-2021-WF-sgy-1.jpg', 0, '2023-06-15 12:59:10');
...
--
ALTER TABLE `tbl_order`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121743;
