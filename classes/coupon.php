...
class coupon
{
    ...
    public function UpdateCoupon($data, $id)
    {
        ...
        if ($expiredDate < $releaseDate) {
            ...
            $query = "UPDATE tbl_coupon SET  couponCode ='$couponCode', discountAmount = '$discountAmount', releaseDate = '$releaseDate', expiredDate = '$expiredDate', notes = '$notes' WHERE id = '$id'";
