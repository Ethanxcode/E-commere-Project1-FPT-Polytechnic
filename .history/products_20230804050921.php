    ...
    <div class="col-9 col-md-12">
        ...
        <div class="box">
            <div class="row" id="products">
                ...
                if (isset($search_product)) {
                    $product_results = $search_product;
                } elseif (isset($show_category_product)) {
                    $product_results = $show_category_product;
                } elseif (isset($show_brand_product)) {
                    $product_results = $show_brand_product;
                } elseif (isset($show_isStock_product)) {
                    $product_results = $show_isStock_product;
                } else {
                    $product_results = $all_product;
                }
