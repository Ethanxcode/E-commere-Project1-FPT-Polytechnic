                            ...
                            <div class="col-lg-4 bg-grey">
                                <form method="post">
                                    <div class="p-5">
                                        ...
                                        <div class="d-flex justify-content-between mb-2d-flex justify-content-between mb-4 flex-column          <h6 class="
                                            text-muted">Phí vận chuyển</h6>
                                            <h6>
