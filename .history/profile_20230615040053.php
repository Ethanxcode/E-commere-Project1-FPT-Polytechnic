                    ...
                    <div class="col-lg-8">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <a href="./editprofile.php" class="btn btn-danger w-100" type="submit">Cập nhật thông
                                            tin</a>

                                    </div>
                                    <div class="col-sm-4">
                                        <a href="./changepassword.php" class="btn btn-danger w-100" type="submit">Thay đổi mật
                                            khẩu</a>
