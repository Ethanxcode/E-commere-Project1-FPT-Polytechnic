...
<div class="container">
    ...
    ">
                             ...
                             <div style="color: rgb(128, 128, 137); font-weight: normal;" class="col-sm-9 w-100 mb-0">
    <?php if (!empty($result['address'])) { ?>
                                            <span style="font-weight: 500; color: rgb(0, 171, 86); flex-wrap: nowrap;
                                                ...
                                                -webkit-box-align: center; align-items: center;" class="text-success">Nhà</span>
                                            <input name="address" type="hidden" class="form-control text-muted mb-0" value="<?php echo $result['address']; ?>">
                                            <span>
                                                <?php echo $result['address'] ?>
                                            </span>
                                        <?php } else { ?>
                                            <span style="font-weight: 500; color: red; flex-wrap: nowrap;
                                                background-color: rgb(239, 255, 244); font-size: 12px; line-height: 16px;
                                                padding: 0px 6px; border-radius: 100px; height: 18px; display: inline-flex;
                                                -webkit-box-align: center; align-items: center;" class="text-danger">Nhà</span>
                                            <input type="text" name="address" class="form-control text-muted mb-0" placeholder="">
                                        <?php } ?>
                                    </div>
                                            </div>
                                        </div>
