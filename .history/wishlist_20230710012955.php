                                ...
                                if ($get_compare) {
                                    ...
                                    foreach ($get_compare as $result) {
                                        ...
                                        <div class="row mb-4 d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="col-md-2 col-lg-2 col-xl-2 text-end col-sm-12">
                                                <a href="./product-detail.php?proid=<?php echo $result['productId'] ?>" class=" btn btn-dark text-light">Mua
                                                            Ngay</a>
                                                        <a href="?id=<?php echo $result['id']; ?>" class=" btn btn-dark text-light">Xóa</a>
                                                    </div>
