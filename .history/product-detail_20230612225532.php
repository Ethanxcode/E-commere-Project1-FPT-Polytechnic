...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['comment']) && $_POST['comment'] != null) {
    ...
    $insertWishlist = $product->insert_comment($productid, $customerName, $comment);
    ...
    <div class="container">
                ...
                <div class="row product-row">
                    ...
                    <div class="col-7 col-md-12">
                        <div class="product-info">
                            ...
                            <div class="product-info-price">$<?php
                            ...
                            <form action="" method="post">
                                ...
                                <input style="margin: 0;" value="1" min="1" type="number" name="quantity" class="product-quantity"><br><br>
                                <hr><br>
                                <div>
                                    <button type="submit" name="submit" class="btn-flat btn-hover">add to cart</button>

                                </div>
                                <h5 style="font-weight: bold; color: red;"><?php
                            ...
                            ?>
                                <form action="" method="post">
                                    <input type="hidden" name="productid" class="btn-flat btn-hover" value="<?php echo $result_detail['productId'] ?>"></button>
                                    <input type="submit" name="compare" class="btn-flat btn-hover" value="So Sánh"></button>

                                </form>
                                <form action="" method="post">
                                    <input type="hidden" name="productid" class="btn-flat btn-hover" value="<?php echo $result_detail['productId'] ?>"></button>
                                    <input type="submit" name="wishlist" class="btn-flat btn-hover" value="Yêu Thích"></button>
        ...
        <div class="box">
            ...
            <div>
                ...
                if ($login_cheack == false) {
                ?>
                    <p>Đăng nhập bình luận
                        <a href="./login.php" class="btn btn-primary">Đăng nhập</a>
                ...
                ?>
                    <div class="user-rate">
                        ...
                        <div class="user-rate-content">
                            <form action="" method="post">
                                <textarea name="comment" placeholder="Đánh giá của bạn" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                ...
                ?>
                        <div class="user-rate">
                            <div class="user-info">
                                ...
                                <div class="user-name">
                                    <span class="name"><?php echo $result['customerId'];  ?></span>
                                </div>
                            </div>
                            <div class="user-rate-content">
