                    ...
                    foreach ($get_cart_order as $result) {
                        ...
                        <div class="row mb-4 d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-12 col-lg-3 col-xl-2 col-sm-12 text-center">
                                ...
                                <?php
                                if ($result['status'] == 0) {
                                    echo '<h6 class=" btn btn-flat btn-hover w-100">Đang xử lý</h6>';
                                } elseif ($result['status'] == 1) {
                                    echo '<h6 class="btn-flat btn-hover w-100">Đang giao </h6>';
                                    ?>
                                    ...
                                    ?>
                                    <h6 class="text-success alert alert-success btn btn-flat mb-0 w-100">Đã Nhận</h6>
