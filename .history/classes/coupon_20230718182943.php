...
class coupon
{
    ...
    public function insert_product($data)
    {
        ...
        if ($couponCode == "" || $brand == "" || $category == "" || $notes == "" || $price == "" || $type == "" || $file_name == "") {
            $alert = "<span>Các Trường không được phép rỗng</span>";
            return $alert;
        } else {
            move_uploaded_file($file_temp, $uploaded_image);
            $query = "INSERT INTO tbl_product(couponCode,brandId,catId,notes,price,type,image) VALUE('$couponCode','$brand','$category','$notes','$price','$type','$unique_image')";
