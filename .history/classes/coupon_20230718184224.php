...
class coupon
{
    ...
    public function insert_product($data)
    {
        ...
        if ($couponCode == "" || $expiredDate == "" || $releaseDate == "" || $notes == "" || $discountAmount == "") {
            ...
            $query = "INSERT INTO tbl_product(couponCode,,catId,notes,discountAmount,type,image) VALUE('$couponCode','$expiredDate','$releaseDate','$notes','$discountAmount')";
    ...
    {
        $query = "SELECT * FROM tbl_coupon ORDER BY expiredDateId desc ";
