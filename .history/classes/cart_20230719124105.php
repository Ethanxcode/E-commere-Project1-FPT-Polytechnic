...
class cart
{
    ...
    public function insertOrder($customer_id, $totalPrice, $notes, $address)
    {
        ...
        if ($get_product) {
            ...
            $insert_order_items = "INSERT INTO tbl_order_items (order_id, customer_id, order_date, notes, total_price, address) 
        VALUES ('$order_id', '$customer_id', NOW(), '$notes', '$totalPrice','$address')";
    ...
    VALUES ('$customer_id', NOW(), '$notes', '$totalPrice','$address')";
            ...
            // Chuyển hướng người dùng đến trang success.php
