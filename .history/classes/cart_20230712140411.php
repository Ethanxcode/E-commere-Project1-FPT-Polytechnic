...
class cart
{
    ...
    public function checkCoupon($couponCode, $currentTime)
    {
        ...
        if ($result) {
            ...
            $response = array(
                'isValid' => false,
                'errorMessage' => '<div class="alert alert-danger" role="alert">' . $errorMessage . ' tiếp tục đến trang đặt hàng? <a class="btn-danger text-danger" href="/offline.php">Tiếp tục</a></a></div>'
            );
        }
