        ...
        if ($result) {
            foreach ($result as $coupon) {
                ...
                $response = array(
                    ...
                    'errorMessage' => '<div class="alert alert-success" role="alert">Mã giảm giá đã được áp dụng.</div>'
                );
            }
        } else {
            ...
            $response = array(
                'isValid' => false,
                'errorMessage' => '<div class="alert alert-danger" role="alert">' . $errorMessage . ' bạn có muốn tiếp tục đến trang đặt hàng? <a href="/offline.php">Tiếp tục</a></a></div>'
            );
        }
