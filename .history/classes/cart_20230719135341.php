...
class cart
{
    ...
    JOIN
        (SELECT orderId, MAX(date_order) AS latest_order_date
        FROM tbl_order
        GROUP BY orderId) latest_orders
    ON o.orderId = latest_orders.orderId AND o.date_order = latest_orders.latest_order_date
    WHERE
