...
class product
{
    ...
    public function insert_comment($productid, $customerid, $customerName, $comment)
    {
        ...
        if (empty($comment)) {
            ...
            $query = "INSERT INTO tbl_review(productId,customerId,customerName,comment,CreatedAt) VALUE('$productid','$customerid','$comment', '$createdAt')";
            $result = $this->db->insert($query);
            $alert = '
        <div class="alert alert-danger" role="alert">
    ...
    public function insert_comment($productid, $customerid, $customerName, $comment)
    {
        ...
        if (empty($comment)) {
            ...
            $query = "INSERT INTO tbl_review (productId, customerId, customerName, comment, CreatedAt) VALUES ('$productid', '$customerid', '$customerName', '$comment', '$createdAt')";
            $result = $this->db->insert($query);
            $alert = '
    <div class="alert alert-danger" role="alert">
        Cập nhật bình luận thành công
