...
class coupon
{
    ...
    public function insertCoupon($data)
    {
        ...
        if ($couponCode == "" || $expiredDate == "" || $releaseDate == "" || $notes == "" || $discountAmount == "") {
            ...
            $query = "INSERT INTO tbl_coupon(couponCode,discountAmount,catId,notes,discountAmount,type,image) VALUE('$couponCode','$expiredDate','$releaseDate','$notes','$discountAmount')";
