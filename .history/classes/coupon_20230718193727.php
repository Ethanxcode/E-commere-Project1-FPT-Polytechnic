...
class coupon
{
    ...
    public function UpdateCoupon($data, $id)
    {
        ...
        if ($expiredDate < $releaseDate) {
            ...
            $query = "UPDATE tbl_product SET  tbl_coupon(couponCode,discountAmount ,releaseDate,expiredDate, notes) VALUE('$couponCode','$discountAmount','$releaseDate','$expiredDate','$notes')";
