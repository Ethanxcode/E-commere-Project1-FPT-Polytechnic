...
class coupon
{
    ...
    public function insert_product($data)
    {
        ...
        if ($couponCode == "" || $brand == "" || $category == "" || $product_desc == "" || $price == "" || $type == "" || $file_name == "") {
            ...
            $query = "INSERT INTO tbl_product(couponCode,brandId,catId,product_desc,price,type,image) VALUE('$couponCode','$brand','$category','$product_desc','$price','$type','$unique_image')";
