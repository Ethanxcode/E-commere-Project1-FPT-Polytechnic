    ...
    }public function insert_product($data)
{
    ...
    if ($couponCode == "" || $expiredDate == "" || $releaseDate == "" || $notes == "" || $discountAmount == "" || $type == "" || $file_name == "") {
        $alert = "<span>Các trường không được phép trống</span>";
        return $alert;
    } else {
        move_uploaded_file($file_temp, $uploaded_image);
        $query = "INSERT INTO tbl_product(couponCode,expiredDate,releaseDate,notes,discountAmount,type,image) VALUES('$couponCode','$expiredDate','$releaseDate','$notes','$discountAmount','$type','$unique_image')";
