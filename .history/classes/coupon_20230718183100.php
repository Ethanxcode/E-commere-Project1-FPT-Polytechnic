...
class coupon
{
    ...
    public function insert_product($data)
    {
        ...
        if ($couponCode == "" || $expiredDate == "" || $releaseDate == "" || $notes == "" || $discountAmount == "" || $type == "" || $file_name == "") {
            ...
            $query = "INSERT INTO tbl_product(couponCode,expiredDateId,catId,notes,discountAmount,type,image) VALUE('$couponCode','$expiredDate','$releaseDate','$notes','$discountAmount','$type','$unique_image')";
