...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $catname = $_GET['categoryId'];
    $show_category_product = $product->show_category_product($catname, $current_page);
    $query = "SELECT * FROM tbl_product WHERE categoryId = '$catname'  ";
    $stmt = $db->select($query);
    $total_results = count($stmt);
                        ...
                        <ul class="filter-list">
                            ...
                            if ($show_cate) {
                                foreach ($show_cate as $result) {
                                    ?>
                                            <li><a href="?categoryId=<?php echo $result['categoryId']; ?>"><?php echo $result['catName']; ?></a>
                                            </li>
                                            <?php
                                }
                            }
