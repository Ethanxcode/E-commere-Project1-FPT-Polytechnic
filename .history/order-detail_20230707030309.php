                    ...
                    foreach ($get_cart_order as $result) {
                        ...
                        <div class="row mb-4 d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-4 col-lg-3 col-xl-3 col-sm-12">
                                <h6 class="text-muted text-center">Tên Sản phẩm</h6>
                                <h6 class="text-black mb-0">
                                    <?php echo $result['productName'] ?>
                                </h6>
                            </div>
                            <div class="col-md-4 col-lg-3 col-xl-2 col-sm-12">
                                <h6 class="text-muted text-center">Giá </h6>
                                <h6 class="text-black mb-0">
                                    <?php echo $fm->formatNumber($result['price'] / $result['quantity'] + $result['price'] / $result['quantity'] * 0.1) ?>
                                </h6>
                            </div>

                            <div class="col-md-3 col-lg-3 col-xl-1 col-sm-12">
                                <h6 class="text-muted text-center">Số Lượng</h6>
                                <h6 class="text-black mb-0">
                            ...
                            <!-- <div class="col-md-4 col-lg-3 col-xl-3 col-sm-12">
                                <h6 class="text-muted text-center">Tổng Giá</h6>
                            ...
                            <div class="col-md-4 col-lg-3 col-xl-3 col-sm-12">
                                <h6 class="text-muted text-center">Ngày đặt</h6>
                                <h6 class="text-black mb-0">
                                    <?php echo $fm->formatDate($result['date_order']) ?>
                                </h6>
                            </div>
                            <div class="col-md-4 col-lg-3 col-xl-2 col-sm-12">
                                <h6 class="text-muted text-center">Trạng thái</h6>
