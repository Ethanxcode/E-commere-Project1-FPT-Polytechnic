                    ...
                    <div class="col-7 col-md-12">
                        <div class="product-info">
                            ...
                            <div class="product-info-detail">
                                ...
                                <a class="text-muted" href="products.php?brandid=<?php echo $result_detail['brandId']; ?>">
                                    <?php
                            ...
                            <div class="product-info-detail">
                                <span class="product-info-detail-title">Tồn kho:</span>
                                <span class="text-muted">
                                    <?php
                                    echo $result_detail['stock'] > 0 ? $result_detail['stock'] : 'Hết hàng ';
                                    ?>
                                </span>
                            </div>
                            <div class="product-info-detail">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="d-flex align-items-center" style="gap: .4rem">
                                    <div>
                                        <?php echo $result_detail['stock'] > 0 ? '<button type="submit" name="submit" class="btn-flat btn-hover">Giỏ hàng</button>' : '<button type="submit" disabled name="submit" class="btn-flat btn-hover btn-disabled">Giỏ hàng</button>'; ?>
                                    </div>

                                    <button disabled>fasd</button>
                                    <?php
