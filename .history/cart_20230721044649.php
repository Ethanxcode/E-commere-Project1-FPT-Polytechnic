...
if (isset($_POST['shoppingCartForm']) || $_SERVER['REQUEST_METHOD'] == 'POST') {
...
<section class="h-100 h-custom" style="background-color: #d2c9ff;">
    <form method="post" name="shoppingCartForm">
                                                ...
                                                <div class="row mb-4 d-flex justify-content-between align-items-center ">
                                                    ...
                                                    <div class="col-md-2 col-lg-2 col-xl-2 col-sm-12">
                                                        ...
                                                        <form class="d-flex w-75" method="post">
                                                            ...
                                                            <button class=" btn-link border-0 bg-transparent px-1"
                                                                type="submit">
                                ...
                                <div class="col-lg-4 bg-grey">
                                    <form method="post">
                                        <div class="p-5">
                                            ...
                                            <button type="button"
                                                class="btn btn-dark btn-block btn-sm w-100 p-3 disabled"
