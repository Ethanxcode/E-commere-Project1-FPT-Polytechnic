...
if (isset($_POST['couponCode']) && isset($_POST['cartId2']) && isset($_POST['quantity2']) && $_SERVER['REQUEST_METHOD'] == 'POST') {
    $couponCode = $_POST['couponCode'];
    $quantity2 = $_POST['quantity2'];
    $cartId2 = $_POST['cartId2'];
    $currentTime = date('Y-m-d H:i:s'); // Thời gian hiện tại

    // Gọi phương thức kiểm tra mã giảm giá từ lớp xử lý dữ liệu (ví dụ: $ct)

    $update_quantity_cart = $ct->update_quantity_cart($quantity2, $cartId2);
                                ...
                                <form method="post">
                                    <div class="p-5">
                                        ...
                                        <div class="d-flex justify-content-between mb-4 flex-column"
                                            ...
                                            <input name="couponCode" type="text" class="form-control"
                                                placeholder="Coupon..." />
                                            <input value="<?php echo $result['cartId']; ?>" type="hidden" name="cartId2"
                                                id="cartId2">
                                            <input min="0" name="quantity2" id="quantity2"
                                                value="<?php echo $result['quantity'] ?>" hidden type="number" />
