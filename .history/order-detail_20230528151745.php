                ...
                ?>
                        ...
                        <div class="row mb-4 d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-1 col-lg-1 col-xl-1">
                                ...
                                <h6 class="text-black mb-0"><?php echo $fm->formatNumber($result['price'] / $result['quantity'] + $result['price'] / $result['quantity'] * 0.1) ?></h6>
                            </div>
                            ...
                            <div class="col-md-2 col-lg-2 col-xl-2">
                                ...
                                <h6 class="text-black mb-0"><?php echo $fm->formatDate($result['date_order'])  ?></h6>
                            </div>
                            <div class="col-md-2 col-lg-2 col-xl-2">
                                ...
                                <h6 class="text-black mb-0"><?php
                                    ...
                                    ?>
                                        <h6 class="text-black mb-0">Nhận hàng thành công</h6>
