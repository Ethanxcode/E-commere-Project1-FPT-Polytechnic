                ...
                if ($show_comment) {
                    foreach ($show_comment as $result) {
                        ...
                        if ($customer) {
                            ...
                            ?>
                            <div class="user-rate">
                                <div class="user-info align-items-start">
                                    <img src="./admin/uploads/<?php echo $customerImage; ?>" style="     
                                                                        height: 150px;
                                                                        border-radius: 50%;
                                                                        height: 60px;
                                                                        width: 60px;
                                ...
                                <textarea class="user-rate-content form-control" style="resize: none; user-select: none;" disabled
                                    readonly rows="4"><?php echo $comment; ?></textarea>
