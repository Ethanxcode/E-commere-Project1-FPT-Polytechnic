...
<!-- Đoạn mã HTML và các phần khác của trang "offline.php" -->
Trong đoạn mã trên, chúng ta kiểm tra nếu có tham số "couponCode" được truyền vào URL từ trang trước (giá trị mã giảm
giá). Sau đó, chúng ta gọi phươ
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-4 bg-grey">
                                <div class="p-5">
                                    ...
                                    <button type="button" class="btn btn-dark btn-block btn-sm mt-3 w-100 p-3"
                                        data-mdb-ripple-color="dark">
                                        <a href="javascript:void(0);" onclick="redirectToOfflinePage()">Thanh Toán Khi
                                            Nhận Hàng</a>
                                    </button>
                                </div>
                            </div>
