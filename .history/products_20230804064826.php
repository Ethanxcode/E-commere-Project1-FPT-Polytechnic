...
} elseif (isset($_GET['isFeatured'])) {
    $isFeatured = $_GET['isFeatured'];
    $show_isStock_product = $product->show_isFeatured_product($isFeatured, $current_page);
    $query = "SELECT * FROM tbl_product WHERE type = '$isFeatured' ";
    $stmt = $db->select($query);
    $total_results = count($show_isStock_product);
} else {
...
<div class="bg-main">
    ...
    <?php if (isset($_POST['keyword']) && $_POST['keyword'] != ""): ?>
                ...
                <a href="">
                    ...
                    if ($show_brand) {
                        foreach ($show_brand as $result) {
                            if ($result['brandId'] == $_GET['brandid']) {
            ...
            <?php elseif (isset($_GET['isStock'])):
                ...
                <?php elseif (isset($_GET['isFeatured'])):
                        $isFeatured = $_GET['isFeatured'];
                      
        ?>
                    <span><i class='bx bxs-chevrons-right'></i></span>
                    <a href="">
                        <?php echo $isFeatured == 2 ? 'Sản phẩm đặc trưng' : 'Sản phẩm'; ?>
                    </a>
            <?php endif; ?>
        
            <span><i class='bx bxs-chevrons-right'></i></span>
            <a href="">
                <?php echo $total_results != 0 ? $total_results : 'Không tìm thấy'; ?> sản phẩm
            </a>
        </div>
                ...
                <div class="col-3 filter-col" id="filter-col">
                    ...
                    <div class="box ">
                        ...
                        <ul class="filter-list">
                            ...
                            <li><a href="?isFeatured=2">Sản phẩm đặc trưng</a></li>
