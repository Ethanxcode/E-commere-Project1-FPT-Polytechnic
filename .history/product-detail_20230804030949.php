                        ...
                        <div class="product-info">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="d-flex align-items-center" style="gap: .4rem">
                                    <div>
                                        <?php echo $result_detail['stock'] > 0 ? '<button type="submit" name="submit" class="btn-flat btn-hover">Giỏ hàng</button>' : '<button type="submit" disabled name="submit" class="btn-flat btn-hover disabled">Giỏ hàng</button>'; ?>
                                    </div>
