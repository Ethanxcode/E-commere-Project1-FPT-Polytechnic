...
<div class="container">
    ...
    ">
        ...
        font-weight: 600;">
                            fonts
                            <h6 class="text-capitalize">Đơn hàng</h6>
                        ...
                        <div class="d-flex justify-content-between mb-2 ">
                            <h6 class="text-capitalize text-muted">Tạm tính</h6>
                            <h6>
                                <?php echo $fm->formatNumber($tongSp + 0.1 * $tongSp) ?>
                            </h6>
                        </div>
                        <div class="d-flex justify-content-between mb-2 ">
                            <h6 class="text-capitalize text-muted">Phí Vận chuyển</h6>
                            <h6>
                                <?php echo $fm->formatNumber($tongSp + 0.1 * $tongSp) ?>
                            </h6>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mb-2 ">
                            <h6 class="text-capitalize text-muted">Giảm giá</h6>
                            <h6>
                                <?php echo $fm->formatNumber($tongSp + 0.1 * $tongSp) ?>
                            </h6>
                        </div>
                        <h6 class="text-capitalize text-muted mb-3">VAT 10%</h6>

                        <hr class="my-4">

                        <div class="d-flex justify-content-between mb-2 ">
                            <h6 class="text-capitalize text-muted">Tổng cộng</h6>
                            <h6>
                                <?php echo $fm->formatNumber($tongSp + 0.1 * $tongSp) ?>
                            </h6>
                        </div>
