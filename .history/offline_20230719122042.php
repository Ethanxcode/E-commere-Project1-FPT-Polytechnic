...
if (isset($_GET['orderid']) && $_GET['orderid'] == 'order') {
    ...
    $insertOrder = $ct->insertOrder($customer_id, $totalPrice, $notes); // Pass the notes parameter
...
<div class="container">
    ...
    ">
        ...
        font-weight: 600;">
                        ...
                        <button type="submit" name="orderid" class="btn btn-dark btn-block btn-lg w-100"
