        ...
        <div class="row">
            <div class="col-4 col-md-12 col-sm-12">
                <div class="promotion-box">
                    <div class="text">
                        <h3>Iphone</h3>
                        <button class="btn-flat btn-hover"><a href="./products.php"><span>shop collection</span></a></button>
                    </div>
            ...
            <div class="col-4 col-md-12 col-sm-12">
                <div class="promotion-box">
                    ...
                    <img src="./images/iphoneCollection.jpeg" alt="">
                </div>
            </div>
            <div class="col-4 col-md-12 col-sm-12">
                <div class="promotion-box">
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="blog">
                <div class="blog-img">
                    <img src="./images/Mobile Phones Unboxing _ iPhone - Apple (IN) _ Samsung India _ Mobile _ TV New mobile launch - FULL.jpg" alt="">
                </div>
                <div class="blog-info">
