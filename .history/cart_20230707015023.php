                        ...
                        <div class="row g-0">
                                    ...
                                    if ($get_product_cart) {
                                        foreach ($get_product_cart as $result) {
                                            ...
                                            <div class="row mb-4 d-flex justify-content-between align-items-center ">
                                                ...
                                                <div class="col-md-12 col-lg-1 col-xl-1 d-flex justify-content-end ">
                                                    <a href="?cartId=<?php echo $result['cartId']; ?>" class=" btn "
                                                        style="font-size: 22px; align-items: center"><i
                            ...
                            <div class="col-lg-4 bg-grey">
                                <div class="p-5">
                                    ...
                                    <button type="button" class="btn btn-flat " data-mdb-ripple-color="dark">Thanh Toán
                                        Online</button>
                                    <button type="button" class="btn  btn-flat  mt-3" data-mdb-ripple-color="dark"><a
                                            href="./offline.php">Thanh Toán Khi Nhận
                                            Hàng</a></button>
