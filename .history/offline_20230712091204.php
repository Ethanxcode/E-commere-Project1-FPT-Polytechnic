...
if (isset($_POST['couponCode'])) {
    ...
    // Gọi hàm checkCoupon từ đối tượng cart
    $cart = new Cart();
    $result = $cart->checkCoupon($couponCode, $currentTime);

    // Trả về kết quả (success, discountAmount, errorMessage) dựa trên kết quả của hàm checkCoupon
    ...
    // Kiểm tra nếu có errorMessage thì thêm vào response
                                    ...
                                    <div class="row">
                                        <div class="col-sm-9 w-100">
                                            <input id="couponCode" name="couponCode" placeholder="Mã giảm giá..."
                                                class=" form-control text-muted mb-0" onmouseleave="applyCoupon()">
                                            </input>
                                        </div>
                                    </div>
                                </div>
