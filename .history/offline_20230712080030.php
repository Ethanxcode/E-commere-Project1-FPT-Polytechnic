    ...
    ">
        ...
        font-weight: 600;">
                        ...
                        <div class="d-flex justify-content-between mb-5">
                            <h5 class="text-capitalize text-muted">Tổng phụ</h5>
                            <h5>
                                <?php echo $fm->formatNumber($tongSp + 0.1 * $tongSp) ?>
                            </h5>
                        </div>
                        <div class="d-flex justify-content-between mb-5">
                            <h5 class="text-capitalize text-muted">Vận chuyển</h5>
                            <h5>
                                <?php echo $fm->formatNumber($tongSp + 0.1 * $tongSp) ?>
                            </h5>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mb-5">
                            <h5 class="text-capitalize text-muted">Giảm giá</h5>
                            <h5>
                                <?php echo $fm->formatNumber($tongSp + 0.1 * $tongSp) ?>
                            </h5>
                        </div>
                        <h5 class="text-capitalize text-muted mb-3">VAT 10%</h5>

                        <hr class="my-4">

                        <div class="d-flex justify-content-between mb-5">
                            <h5 class="text-capitalize text-muted">Tổng cộng</h5>
                            <h5>
                                <?php echo $fm->formatNumber($tongSp + 0.1 * $tongSp) ?>
                            </h5>
                        </div>
