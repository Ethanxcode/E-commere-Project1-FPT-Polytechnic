    ...
    <div class="row">
        <div class="col-12">
            <div class="p-5">
                ...
                $slSp = 0;
                var_dump($get_cart_order);

                if ($get_cart_order) {
                    foreach ($get_cart_order as $order) {
                        echo "Mã đơn hàng: " . $order['order_id'] . "<br>";
                        echo "Ngày đặt hàng: " . $order['date_order'] . "<br>";
                        foreach ($order['products'] as $result) {
                            $slSp++;
                            ...
                            <div class="row mb-4 d-flex justify-content-between align-items-center">
                                ...
                                <div class="col-md-12 col-lg-3 col-xl-2 col-sm-12 text-center">
                                    ...
                                    <?php
                                    if ($result['status'] == 0) {
                                        echo '<h6 class="text-danger mb-0 alert alert-danger">Đang chờ xử lý</h6>';
