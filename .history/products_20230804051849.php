                            ...
                            <div class="product-card">
                                ...
                                <div class="product-card-info">
                                    ...
                                    <div class="product-card-description">
                                        <span class="">Sales: <?php echo $result['sales']; ?></span>
                                        <span><del><?php echo $fm->formatNumber($result['price'] * 1.2); ?></del></span>
                                        <div class="product-card-price">
                                            <span class="curr-price"><?php echo $fm->formatNumber($result['price']); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="box">
            <ul class="pagination">
                ...
                <?php for ($page = 1; $page <= $total_pages; $page++) : ?>
                    <li>
                        <a class="<?php if ($page == $current_page) echo "active"; ?>" href="products.php?page=<?php echo $page ?><?php if (isset($brandname) || isset($catname)) {
                            if (isset($brandname)) {
