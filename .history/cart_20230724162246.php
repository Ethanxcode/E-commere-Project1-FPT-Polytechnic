                                        ...
                                        foreach ($get_product_cart as $result) {
                                            ...
                                            <div class="row mb-4 d-flex justify-content-between align-items-center ">
                                                ...
                                                <div class="col-md-2 col-lg-2 col-xl-2 col-sm-12">
                                                    ...
                                                    <form class="d-flex w-75" action="" method="post">
...
<script type="text/javascript">
    ...
    document.getElementById("payOnlineButton").addEventListener("click", function() {
        ...
        if (couponCode.trim() !== "") {
            // Perform AJAX request to validate coupon on the server-side
            // You should implement this part on the server and handle coupon validation
            // After validating, you can update the UI accordingly
        }

        // Update quantity if necessary
        // Note: You can add further validation for quantity here if needed
