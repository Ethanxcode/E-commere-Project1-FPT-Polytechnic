...
if (isset($_GET['orderid']) && $_GET['orderid'] == 'order') {
    ...
    $insertOrder = $ct->insertOrder($customer_id, $totalPrice, $notes, $address, $discountValue, $quantity);
...
<section class="h-100 h-custom" style="background-color: #e3e3e3;">
                        ...
                        foreach ($get_cart_order as $result) {
                            ...
                            <div class="row mb-4 d-flex justify-content-between align-items-center">
                                ...
                                <div class="col-md-12 col-lg-3 col-xl-2 col-sm-12 text-center">
                                    ...
                                    <a href="./invoice.php?orderid=<?= $result['id']; ?>">
                                        <h6 class="text-primary mb-0 alert alert-primary">Xem chi tiết</h6>
                                    </a>
                                </div>
                                ...
                                <!-- <div class="col-md-12 col-lg-3 col-xl-2 col-sm-12 text-center">
                                    ...
                                    if ($result['status'] == 0) {
                                        ...
                                        echo '<a href="./invoice.php?orderid=' . $result['id'] . '">
                                            <h6 class="text-muted alert alert-disabled mb-0">Đã Hủy</h6>
                                        </a>';
                                        ?>
                                        <?php
                                    }
