                            ...
                            <div class="col-lg-4 bg-grey">
                                <form method="post">
                                    <div class="p-5">
                                        ...
                                        <input id="form1" min="0" name="quantity" hidden
                                            value="<?php echo $result['quantity'] ?>" type="number" <button
                                            type="button" class="btn btn-dark btn-block btn-sm w-100 p-3 disabled"
