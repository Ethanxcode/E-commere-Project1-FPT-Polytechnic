...
if (isset($_POST['couponCode'])) {
    ...
    // Thực hiện truy vấn SQL để kiểm tra mã giảm giá
    // Trả về kết quả (success, discountAmount, errorMessage) dựa trên kết quả truy vấn

    $response = array(
        'success' => true,
        // true nếu mã giảm giá hợp lệ, false nếu không hợp lệ
        'discountAmount' => 100,
        // Số tiền được giảm sau khi áp dụng mã giảm giá
