...
if (isset($_GET['orderid']) && $_GET['orderid'] == 'order') {
    ...
    $addres = isset($_POST['address']) ? $_POST['address'] : ''; // Get the value of the notes field from the form
    $insertOrder = $ct->insertOrder($customer_id, $totalPrice, $notes, $address); // Pass the notes parameter
...
<div class="container">
    ...
    ">
        ...
        font-weight: 600;">
                        ...
                        <button type="submit" name="submit" class="btn btn-dark btn-block btn-lg w-100"
