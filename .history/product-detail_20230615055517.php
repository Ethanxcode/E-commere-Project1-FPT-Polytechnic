                ...
                if ($show_comment) {
                    foreach ($show_comment as $result) {
                        ...
                        if ($customer) {
                            ...
                            ?>
                            <div class="user-rate">
                                <div class="user-info flex flex-column" style="display: flex">

                                    <img src="./admin/uploads/<?php echo $customerImage; ?>" style="     height: 150px;
                                    border-radius: 50%;
                                    height: 60px;
                                    width: 60px;
                                    object-fit: cover;">
                                    ...
                                    <div class="user-rate-time">
                                        <span style="
                                        margin-top: 0.25rem;
                                        margin-bottom: 0.9375rem;
                                        font-size: .75rem;
                                        color: rgba(0,0,0,.54);" class="user-rate">
