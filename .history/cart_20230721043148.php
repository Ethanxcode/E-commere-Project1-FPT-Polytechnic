                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="d-flex justify-content-between mb-4 flex-column"
                                            ...
                                            <input id="couponCode" name="couponCode" type="text" class="form-control"
                                                placeholder="Coupon..." />
                                                  <input value="<?php echo $result['cartId']; ?>" type="hidden" name="cartId2" id="cartId2">
                                                <input min="0" name="quantity2" id="quantity2" value="<?php echo $result['quantity'] ?>" hidden type="number" />
