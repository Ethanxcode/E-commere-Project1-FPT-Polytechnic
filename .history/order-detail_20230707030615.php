                ...
                if ($get_cart_order) {
                    foreach ($get_cart_order as $result) {
                        ...
                        <div class="row mb-4 d-flex justify-content-between align-items-center">
                            <div class="col-md-12 col-lg-12 col-xl-1 col-sm-12">
                                <img src="./admin/uploads/<?php echo $result['image'] ?>" class="img-fluid rounded-3"
                                    alt="Cotton T-shirt">
                            </div>
                            <div class="col-md-12 col-lg-12 col-xl-3 col-sm-12 text-center">
                                <h6 class="text-muted">Tên Sản phẩm</h6>
                                <h6 class="text-black mb-0">
                                    <?php echo $result['productName'] ?>
                                </h6>
                            </div>
                            <div class="col-md-2 col-lg-1 col-xl-2 col-sm-12 text-center">
                            ...
                            <div class="col-md-1 col-lg-2 col-xl-1 col-sm-12 text-center">
                            ...
                            <!-- <div class="col-md-4 col-lg-3 col-xl-3 col text-center-sm-12">
                            ...
                            <div class="col-md-4 col-lg-3 col-xl-3 col-sm-12 text-center">
                                <h6 class="text-muted">Ngày đặt</h6>
                                <h6 class="text-black mb-0">
                                    <?php echo $fm->formatDate($result['date_order']) ?>
                                </h6>
                            </div>
                            <div class="col-md-4 col-lg-3 col-xl-2 col-sm-12 text-center">
                                <h6 class="text-muted">Trạng thái</h6>

                                <?php
                                if ($result['status'] == 0) {
                                    echo '<h6 class="text-warning mb-0 alert alert-warning">Đang chờ xử lý</h6>';
                                } elseif ($result['status'] == 1) {
                                    echo '<h6 class="text-primary mb-0 alert alert-primary">Đã xử lý</h6>';
                                    ?>
