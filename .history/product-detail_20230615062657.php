                        ...
                        if ($customer) {
                            ...
                            <div class="user-rate">
                                <div class=" d-flex justify-content-between">
                                    <div class="user-info align-items-start d-flex justify-content-between align-content-center">
                                    ...
                                    <ul class="mega-dropdown"><i style="font-size: 24px; " class='bx bx-dots-vertical-rounded'></i>
