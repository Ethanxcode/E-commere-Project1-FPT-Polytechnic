								...
								<tr class="odd gradeX">
									...
									if ($result['status'] == 0) {
										...
										<td><a class="btn btn-danger"
												href="?shiftid=<?php echo $result['id'] ?>&price=<?php echo $result['total_price'] ?>&time=<?php echo $result['date_order'] ?>">
												xác thực</a></td>
										<?php
										...
										<td>
											<a class="btn btn-warning"
												href="?shiftid=<?php echo $result['id'] ?>&total_price=<?php echo $result['total_price'] ?>&time=<?php echo $result['date_order'] ?>">
												Giao hàng</a>
										</td>
										<?php
