            ...
            <form action="" method="post">
             ...
             <div class="row mt-3">
                    <div class="col-md-6">
                        ...
                        <button class="btn btn-primary" name="selectAll" onclick="selectAll(event)">Chọn tất cả</button>
                        <button class="btn btn-secondary" name="deselectAll" onclick="deselectAll(event)">Bỏ chọn tất cả</button>
