								...
								<tr class="odd gradeX">
									...
									if ($result['status'] == 0) {
										...
										<td><a class="btn btn-danger"
												href="?shiftid=<?php echo $result['id'] ?>&price=<?php echo $result['price'] ?>&time=<?php echo $result['date_order'] ?>">
												xác thực</a></td>
										<?php
										...
										<td>
											<a class="btn btn-warning"
												href="?conf=<?php echo $customer_id ?>&price=<?php echo $result['price'] ?>&time=<?php echo $result['date_order'] ?>">
												Giao hàng</a>
										</td>
										<?php
										...
										<td>
											<button class="btn-primary btn"><a
													href="?conf=<?php echo $customer_id ?>&price=<?php echo $result['price'] ?>&time=<?php echo $result['date_order'] ?>">Đã
													nhận hàng</a></button>
											<button class="btn-primary btn"><a
													href="?conf=<?php echo $customer_id ?>&price=<?php echo $result['price'] ?>&time=<?php echo $result['date_order'] ?>">Đã
													nhận hàng</a></button>
