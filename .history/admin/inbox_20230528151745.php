					...
					<tbody>
						...
						?>
								<tr class="odd gradeX">
									...
									if ($result['status'] == 0) {
									?>
										<td><a href="?shiftid=<?php echo $result['id'] ?>&price=<?php echo $result['price'] ?>&time=<?php echo $result['date_order'] ?>">Đang chờ xử lý</a></td>
									<?php
									...
									?>
										<td><a href="?delid=<?php echo $result['id'] ?>&price=<?php echo $result['price'] ?>&time=<?php echo $result['date_order'] ?>">Xóa</a></td>
									<?php
									}
									?>
								</tr>
