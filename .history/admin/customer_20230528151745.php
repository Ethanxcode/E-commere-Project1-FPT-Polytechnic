                        ...
                        <form action="" method="post">
                            <table class="table border-primary table-hover" id="dataTable" width="100%" cellspacing="0">
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <input name="catName" readonly="readonly" value="<?php echo $result['hovaten']  ?>" type="text" class="medium" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>SĐT</td>
                                    <td>:</td>
                                    <td>
                                        <input name="catName" readonly="readonly" value="<?php echo $result['sodienthoai']  ?>" type="text" class="medium" />
                                    </td>
                                </tr>
                            </table>
                        </form>
