...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="row mt-3">
                <div class="col-md-6">
                    <button type="button" class="btn btn-primary" name="selectAll" onclick="selectAll = () => {
        ...
        checkboxes.forEach((checkbox) => {
            checkbox.checked = true;
                        ...
                        tất
                        cả</button>
                    <button type="button" class="btn btn-secondary" name="deselectAll" onclick="deselectAll = () => {
                            preventDefault(); // Ngăn chặn sự kiện mặc định của nút submit
        let checkboxes = document.getElementsByName('selectedItems[]');
        checkboxes.forEach((checkbox) => {
