...
if (isset($_POST['deleteSelected'])) {
    ...
    $alert = $pd->delete_selected_comments($selectedItems);
}
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="" method="post">
            ...
            <div class="row mt-3">
                <div class="col-md-6">
                    <button class="btn btn-danger" name="deleteSelected">Xóa mục đã chọn</button>
                    <button class="btn btn-primary" name="selectAll">Chọn tất cả</button>
                    <button class="btn btn-secondary" name="deselectAll">Bỏ chọn tất cả</button>
                </div

</div>

<?php
// Xử lý yêu cầu xóa mục đã chọn
if (isset($_POST['deleteSelected'])) {
    if (isset($_POST['selectedItems'])) {
        ...
        if (!empty($selectedItems)) {
            ...
            echo '<script>alert("Đã xóa các mục đã chọn.");</script>';
            // Reload hoặc làm gì đó khác sau khi xóa
            // ...
        } else {
            echo '<script>alert("Vui lòng chọn ít nhất một mục để xóa.");</script>';
        }
    }
}
?>
