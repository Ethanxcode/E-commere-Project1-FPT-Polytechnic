        ...
        <div class="table-responsive">
            <table class="table border-primary table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tr class="align-items-center">
                    ...
                    <td>
                        <textarea class="form-control" style="resize: none;"  cols="46" rows="4" disabled readonly ><?php echo $result['comment']; ?></textarea>
                    </td>
                    <td>
                        <?php echo date('d/m/Y H:i', strtotime($result['CreatedAt'])); ?>
                    </td>
                    <td>
               <!-- <button class="btn btn-but" type="submit" name="submit">Save</button> -->
                    </td>
                </tr>
                <?php
                        }
