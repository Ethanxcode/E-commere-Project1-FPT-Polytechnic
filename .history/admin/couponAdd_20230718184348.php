...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    $insertProduct = $insertCoupon->insert_product($_POST);
}
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="price" type="discountAmount" placeholder="Enter Percent..."
                                    class="medium form-control" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="date" name="releaseDate" placeholder="Enter Release Day..."
                                    class="medium form-control" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="date" name="expiredDate" placeholder="Enter Ended Day..."
                                    class="medium form-control" />
                            </td>
                        </tr>
                        <tr>
