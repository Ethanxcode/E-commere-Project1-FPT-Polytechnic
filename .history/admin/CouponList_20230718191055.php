...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Danh sách coupon</h6>
        </div>
        <div class="card-body">
                        ...
                        if (!empty($showCoupon)) {
                            ...
                            foreach ($showCoupon as $result) {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <?php echo $result['releaseDate'] ?>
                                    </td>
                                    <td>
                                        <?php echo $result['expiredDate'] ?>
                                    </td>

                                    <td>
                                        <?php echo $fm->textShorten($result['notes'], 50); ?>
                                    </td>


                                    <td style="display: flex; flex-wrap: nowrap; gap: 4px">
                                        <button type="button" class="btn btn-primary">
                                            <a class="text-white" href="couponEdit.php?id=<?php echo $result['id'] ?>">Sửa</a>
                                        </button>
                                        <button type="button" class="btn btn-danger">
                                            <a class="text-white" onclick="return confirm('Bạn chắc chắn xóa chứ ?')"
                                                href="?delid=<?php echo $result['id'] ?>">Xóa</a>
                                        </button>
                                    </td>
                                </tr>
                                <?php
