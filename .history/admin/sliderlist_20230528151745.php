						...
						?>
								<tr class="odd gradeX">
									...
									<td>
										...
										?>
											<button type="button" class="btn btn-primary"><a class="text-white" href="?slidertype=<?php echo $result_slider['type']; ?>&sliderid=<?php echo $result_slider['id']; ?>">Đã Hiện</a></button>
										...
										?>
											<button type="button" class="btn btn-warning"><a class="text-white" href="?slidertype=<?php echo $result_slider['type']; ?>&sliderid=<?php echo $result_slider['id']; ?>">Đã Tắt</a></button>
									...
									<td>
										<button type="button" class="btn btn-danger"><a class="text-white" href="?delslider=<?php echo $result_slider['id']; ?>" onclick="return confirm('Are you sure to Delete!');">Delete</a></button>
