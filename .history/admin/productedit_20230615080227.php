    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="" method="post">
               ...
               <div class="row mt-3">
    <div class="col-md-6">
        <button type="button" class="btn btn-danger" name="deleteSelected" onclick="document.getElementById('commentForm').submit();">Xóa mục đã chọn</button>
        <button type="button" class="btn btn-primary" name="selectAll" onclick="selectAll(event)">Chọn tất cả</button>
        <button type="button" class="btn btn-secondary" name="deselectAll" onclick="deselectAll(event)">Bỏ chọn tất cả</button>
    </div>
</div>
