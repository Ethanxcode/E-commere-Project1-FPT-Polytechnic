...
?>
<?php
$login_cheack = Session::get('adminlogin');
...
<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="one" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="couponAdd.php">Thêm mã giảm giá</a>
                        <a class="collapse-item" href="couponList.php">Danh sách mã giảm</a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="inbox.php" data-toggle="collapse" data-target="#six"
                    aria-expanded="true" aria-controls="six">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Đơn hàng</span>
                </a>
