								...
								<tbody>
									...
									?>
											<tr>
												...
												<td><button type="button" class="btn btn-primary"><a class="text-white" href="./productedit.php?productid=<?php echo $result['productId']; ?>">Edit</a> </button> || <button type="button" class="btn btn-danger"><a class="text-white" href="?productid=<?php echo $result['productId'] ?>;">Delete</a></button> </td>
											</tr>
									<?php
										}
									};
