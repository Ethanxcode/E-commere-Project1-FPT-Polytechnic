...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 justify-content-between d-flex align-items-center">
            ...
            <span class="text-danger  text-uppercase " style="font-size: 10px;">
                Mật khẩu tương ứng với username</span>
        </div>
                ...
                foreach ($getUserById as $result) {
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tr>
                                <td>
                                    <label for="password">Mật khẩu <p </p></label>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="./uploads/1682044807859_thumb_macbook_air_m1_8gb_256gb_didongviet.webp" width="80"
