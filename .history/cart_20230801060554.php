...
?>
<?php
if (isset($_GET['cartId']) && $_SERVER['REQUEST_METHOD'] == 'GET') {
    $cartId = $_GET['cartId'];
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-4 bg-grey">
                            <div class="p-5">
                                ...
                                <!-- <h5 class="text-muted mb-3">VAT 10%</h5> -->

                                <div class="d-flex justify-content-between mb-4 flex-column" style="gap: 0.8rem">
                                    <h5 class="text-muted">
                                        Mã giảm
                                    </h5>
                                ...
                                <input min="0" name="quantity" value="<?php echo $result['quantity'] ?>"
                                    type="hidden" />
                                <input value="<?php echo $result['cartId']; ?>" type="hidden" name="cartId">
