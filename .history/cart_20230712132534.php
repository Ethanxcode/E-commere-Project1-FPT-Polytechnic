...
if (isset($_GET['couponCode']) && $_SERVER['REQUEST_METHOD'] == 'POST') {
                                            ...
                                            <div class="row mb-4 d-flex justify-content-between align-items-center ">
                                                ...
                                                <div class="col-md-2 col-lg-2 col-xl-2 col-sm-12">
                                                    ...
                                                    <form class="d-flex w-75" action="" method="post">
                                                        ...
                                                        <button class=" btn-link border-0 bg-transparent" type="submit">
                            ...
                            <div class="col-lg-4 bg-grey">
                                <form method="post">
                                    <div class="p-5">
                                        ...
                                        <button type="submit" name="checkCoupon"
                                            class="btn btn-dark btn-block btn-sm mt-3 w-100 p-3"
