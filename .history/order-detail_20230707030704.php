                ...
                if ($get_cart_order) {
                    foreach ($get_cart_order as $result) {
                        ...
                        <div class="row mb-4 d-flex justify-content-between align-items-center">
                            <div class="col-md-12  col-lg-12 col-xl-1 col-sm-12 align-content-center">
                            ...
                            <div class="col-md-12 col-lg-1 col-xl-2 col-sm-12 text-center">
                            ...
                            <div class="col-md-12 col-lg-2 col-xl-1 col-sm-12 text-center">
