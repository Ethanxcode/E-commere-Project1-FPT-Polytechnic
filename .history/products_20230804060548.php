...
<div class="bg-main">
    ...
    <?php
                $breadcrumbs = array(
                    'keyword' => array(
                        'label' => $_POST['keyword'] ?? '',
                        'condition' => isset($_POST['keyword']) && $_POST['keyword'] != "",
                        'link' => ''
                    ),
                    'show_cate' => array(
                        'label' => '',
                        'condition' => isset($show_cate),
                        'link' => '?catid=' . ($_GET['catid'] ?? '')
                    ),
                    'show_brand_product' => array(
                        'label' => '',
                        'condition' => isset($show_brand_product),
                        'link' => '?brandid=' . ($_GET['brandid'] ?? '')
                    )
                );
