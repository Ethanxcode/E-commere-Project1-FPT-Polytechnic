...
<body>
    <section class="hero-wrap hero-wrap-2"
        style="background-image: url('images/Apple-iPhone-14-iPhone-14-Plus-hero-220907_Full-Bleed-Image_jpg_large.jpg');">
        <div class="overlay"></div>
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 pt-5 mt-5 text-center">
                    <p class="breadcrumbs text-black "><span class="me-2 text-black"><a href="index.html">Home <i
                                    class="text-black fa fa-chevron-right"></i></a></span> <span class="text-black me-2"><a
                                href="blog.html">Blog <i class="text-black fa fa-chevron-right"></i></a></span>
                        <span>Blogs
                            <i class="fa fa-chevron-right"></i></span>
                    </p>
                    <h1 class="mb-0 bread text-black">Blog Details</h1>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="col-md-4 border-left d-flex align-items-center">
                            <form action="#" class="subscribe-form">
                                <div class="form-group d-flex align-items-center">
                                    ...
                                    <a href="#" class="btn-icon me-2"><span class="fa fa-paper-plane"></span></a>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-2">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="#"><span class="ion ion-ios-arrow-round-forward me-2"></span>Web Design</a>
                            </li>
                            <li><a href="#"><span class="ion ion-ios-arrow-round-forward me-2"></span>Web
                                    Development</a></li>
                            <li><a href="#"><span class="ion ion-ios-arrow-round-forward me-2"></span>Graphic Design</a>
                            </li>
                            <li><a href="#"><span class="ion ion-ios-arrow-round-forward me-2"></span>UI/UX Design</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                ...
                                <li><a href="#"><span class="icon fa fa-paper-plane"></span><span class="text"><span
                                                class="__cf_email__"
                                                data-cfemail="0b62656d644b72647e796f64666a626525686466">[email&#160;protected]</span></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <p class="mb-0" style="font-size: 14px;">Copyright &copy;
                            ...
                            template is made
                            with <i class="fa fa-heart color-danger" aria-hidden="true"></i> by <a href="#"
                                target="_blank" rel="nofollow noopener">Vision Pro</a>
                        </p>
                    </div>
                </div>
            </div>
