            ...
            <div class="bg-main">
                <div class="mid-header container">
                    ...
                    <ul class="user-menu">
                        ...
                        ?>
                            <li><a href="./compare.php" class="d-flex" style="border: none; background-color: #f5f5f5;"><i class='bx bx-search-alt'></i></a></li>
                        <?php } ?>
                        <?php
                        $login_cheack = Session::get('customer_name');
                        if (isset($login_cheack) && $login_cheack == null) {
                        ...
                        ?>
                            <li><a href="./order-detail.php"><i class='bx bx-search-alt'></i></a></li>
                        <?php } ?>
                        <?php
                        $login_cheack = Session::get('customer_name');
                        if (isset($login_cheack) && $login_cheack == null) {
                        ...
                        ?>
                            <li><a href="./wishlist.php"><i class='bx bx-search-alt'></i></a></li>
                        <?php } ?>
                        <li><a href="#"></a></li>
                        <?php
                        $login_cheack = Session::get('customer_name');
                        ...
                        ?>
                            <li><a href="./profile.php"><i class='bx bx-search-alt'></i></a></li>
                        <?php } ?>

                        <li><a href="./cart.php"><i class='bx bx-search-alt'></i></a></li>
                    </ul>
                </div>
            </div>
            <!-- end mid header -->
