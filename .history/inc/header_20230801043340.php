...
<body>
    ...
    <header>
        ...
        <div class="header-wrapper" id="header-wrapper">
            ...
            <!-- top header -->
            <div class="bg-second">
                <div class="top-header p-4 align-items-center container">
                    <ul class="devided m-0 p-0">
                        <li>
                    ...
                    <ul class="devided m-0 p-0">
                        ...
                        if ($login_cheack == false) {
                            echo "<li><a class=' btn-flat' href='./login.php'>Đăng nhập</a></li>";
                        } else {
                            // echo "đã đăng nhập";
                            echo '<li><a href="">Hi  ' . Session::get('customer_name') . '</a></li>';
                            echo '<li><aclass=' btn-flat' href="?customerid=' . Session::get('customer_id') . ' ">Đăng xuất</aclass=></li>';
                        }
                        ?>
